...
build: asm_objects linker.ld
	$(CC) -g -I lib/includes -I kernel/includes  $(CPP_SOURCES) $(C_SOURCES) $(BUILDDIR)/*.o -o $(BUILDDIR)/kernel.bin -nostdlib -ffreestanding -static-libgcc -lgcc -Ttext=0x4268 linker.ld
asm_objects:
	mkdir -p build
